...
class PN532 {
public:
        PN532(gpio_num_t irqGPIO, gpio_num_t resetGPIO);
...
protected:
        virtual bool read(uint8_t *buff, uint8_t n) = 0;
        virtual void write(uint8_t *cmd, uint8_t cmdlen) = 0;
};